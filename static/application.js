...
haste.prototype.configureButtons = function() {
  ...
  this.buttons = [
    ...
    },
    {
      ...
      label: 'Udemy Course',
      shortcut: function(evt) {
        return _this.options.twitter && _this.doc.locked && evt.shiftKey && evt.ctrlKey && evt.keyCode == 85;
      },
      shortcutDescription: 'control + shift + u',
      action: function() {
        window.open('https://learnspigot.com');
      }
    }
  ];
